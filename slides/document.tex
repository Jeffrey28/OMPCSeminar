...
\end{center}
\end{figure}
\[F_l : \text{Longitudial (tractive) force} \qquad F_c : \text{Lateral (cornering) force}\]
\[v_l : \text{Longitudial (tractive) velocity} \qquad v_l : \text{Lateral (cornering) velocity}\]
\[\dot{x} \quad \dot{y} \quad \dot{\psi} : \text{car velocities in local frame}\]
...
% \end{align*}
\begin{block}{System State and Action}
...
\end{align*}
\[\text{with} \quad H_p : Prediction Horizon \qquad H_c : Control Horizon\]
